...
const LearnPage5 = () => {
  ...
  const lessonData = {
    title: "Milestone 5: Conditionals and Decision Making",
    description:
      "In this lesson, we'll explore conditional statements in Python. Conditional statements allow your programs to make decisions based on different conditions. You'll learn about if, elif, and else statements, comparison operators, and logical operators, which are essential for creating smart, responsive programs.",
    videoUrl: "/videos/milestone5-intro.mp4", // This should be your actual video path
  }
          ...
          <div className="bg-[#003366] rounded-xl overflow-hidden shadow-lg">
            <div className="relative aspect-w-16 aspect-h-9 bg-black">
              <video
                ...
                poster="/images/milestone5-thumbnail.jpg"
            ...
            <div className="bg-white rounded-xl p-6 shadow-md flex items-center">
              ...
              <div>
                <p className="text-gray-700">
                  Conditional statements are like making choices in a video game! If one thing happens, you do this. 
                  If something else happens, you do that. It's how we make our programs smart!
                </p>
              </div>
              <button
