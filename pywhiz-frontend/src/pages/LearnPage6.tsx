...
const LearnPage6 = () => {
  ...
  const lessonData = {
    title: "Milestone 6: Working with Files",
    description:
      "In this lesson, we'll explore how to work with files in Python. Files allow your programs to store and retrieve data permanently. You'll learn how to open, read, write, and close files, which are essential skills for creating programs that can save information and work with external data.",
    videoUrl: "/videos/milestone6-intro.mp4", // This should be your actual video path
  }
          ...
          <div className="bg-[#003366] rounded-xl overflow-hidden shadow-lg">
            <div className="relative aspect-w-16 aspect-h-9 bg-black">
              <video
                ...
                poster="/images/milestone6-thumbnail.jpg"
            ...
            <div className="bg-white rounded-xl p-6 shadow-md flex items-center">
              ...
              <div>
                <p className="text-gray-700">
                  Files are like magic notebooks that remember everything even after you close your program! 
                  This is how we save high scores in games or keep track of important information.
                </p>
              </div>
              <button
