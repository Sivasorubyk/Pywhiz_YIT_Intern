...
const ExercisePage7 = () => {
  ...
  // Hardcoded exercise data for milestone 7
  const exerciseData: Exercise = {
    id: 7,
    title: "Python Error Handling Quiz - Milestone 7",
    description: "Test your understanding of Python error handling. Select the best answer for each question.",
    questions: [
      {
        id: 1,
        text: "What Python statement is used to catch exceptions?",
        options: ["catch", "except", "handle", "error"],
        correctAnswer: 1,
      },
      {
        id: 2,
        text: "Which of the following is the correct structure for handling exceptions in Python?",
        options: [
      ...
      {
        id: 3,
        text: "What happens if an exception is raised but not caught in a Python program?",
        options: [
          "The program continues running from the next line",
          "The program terminates with an error message",
          "The exception is automatically handled by Python",
        ...
        {milestoneAchieved && (
          <div className="bg-green-50 border border-green-200 text-green-700 rounded-xl p-4 mb-8 flex items-center">
            ...
            <div>
              ...
              <p>You've completed Milestone 7! You're now ready to write robust Python code that handles errors gracefully!</p>
            </div>
          </div>
        )}
