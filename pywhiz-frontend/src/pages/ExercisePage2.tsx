...
const ExercisePage2 = () => {
  ...
  // Hardcoded exercise data for milestone 2
  const exerciseData: Exercise = {
    id: 2,
    title: "Python Functions Quiz - Milestone 2",
    description: "Test your understanding of Python functions. Select the best answer for each question.",
    questions: [
      {
        id: 1,
      ...
      {
        id: 2,
        text: "Which of the following is a valid function definition?",
        options: [
        ...
        {milestoneAchieved && (
          <div className="bg-green-50 border border-green-200 text-green-700 rounded-xl p-4 mb-8 flex items-center">
            ...
            <div>
              ...
              <p>You've completed Milestone 2! You're making great progress in your Python journey.</p>
            </div>
          </div>
        )}
