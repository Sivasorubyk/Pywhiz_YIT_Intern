...
const CodePage = () => {
  ...
  const [, setLocalCodeSuccess] = useState(false)
  ...
  return (
    <div className="bg-gradient-to-b from-[#e6f7f7] to-white min-h-[calc(100vh-64px)]">
      <div className="container mx-auto px-4 py-4 md:py-8 h-full" ref={contentRef}>
        ...
        {/* Updated grid with proper height management */}
        <div className={`grid ${isMobile ? "grid-cols-1" : "md:grid-cols-2"} grid-rows-1 gap-4 md:gap-6 h-full`}>
          {/* Left Column - Lesson Info & Output */}
          <div className="flex flex-col h-full space-y-4 md:space-y-6">
            <div className="bg-white rounded-xl p-4 md:p-6 shadow-md flex-1">
              {/* Existing lesson info content */}
            ...
            {/* Video Player (Collapsible) - Fixed height when shown */}
            {showVideo && learnContent && (
              <div className="bg-[#003366] rounded-xl overflow-hidden shadow-lg h-64 md:h-80">
                <div className="relative h-full bg-black">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-[#003366] text-white p-2 md:p-3 flex items-center justify-between">
                    <div className="flex items-center space-x-2">
          ...
          <div className="flex flex-col h-full space-y-4">
            ...
            {currentQuestion?.video_url_2 && (
              <button
                ...
                className="w-full flex items-center justify-center bg-[#e6f7f7] hover:bg-[#d6f0f0] text-[#10b3b3] font-medium py-2 px-4 rounded-lg transition-colors duration-200"
              >
                <Video className="h-4 w-4 mr-2" />
            ...
            {/* Explanation Video - Fixed height when shown */}
            {showExplanationVideo && currentQuestion?.video_url_2 && (
              <div className="bg-white rounded-xl p-4 shadow-md">
                ...
                <div className="bg-[#003366] rounded-xl overflow-hidden shadow-lg h-48 md:h-64">
                  <div className="relative h-full bg-black">
                    <video
