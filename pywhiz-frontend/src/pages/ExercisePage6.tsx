...
const ExercisePage6 = () => {
  ...
  // Hardcoded exercise data for milestone 6
  const exerciseData: Exercise = {
    id: 6,
    title: "Python File Operations Quiz - Milestone 6",
    description: "Test your understanding of Python file operations. Select the best answer for each question.",
    questions: [
      {
        id: 1,
        text: "Which mode is used to open a file for writing, creating a new file if it doesn't exist and overwriting if it does?",
        options: ["'r'", "'a'", "'w'", "'x'"],
        correctAnswer: 2,
      },
      {
        id: 2,
        text: "What is the correct way to read the entire contents of a file called 'data.txt'?",
        options: [
          "with open('data.txt', 'r') as file: data = file.read()",
          "data = open('data.txt').readall()",
          "with open('data.txt', 'w') as file: data = file.read()",
      ...
      {
        id: 3,
        text: "What happens if you don't close a file after opening it?",
        options: [
          "Nothing, Python automatically closes files",
          "The file might remain locked and resources won't be freed",
          "Your program will crash immediately",
        ...
        {milestoneAchieved && (
          <div className="bg-green-50 border border-green-200 text-green-700 rounded-xl p-4 mb-8 flex items-center">
            ...
            <div>
              ...
              <p>You've completed Milestone 6! You now know how to work with files in Python!</p>
            </div>
          </div>
        )}
