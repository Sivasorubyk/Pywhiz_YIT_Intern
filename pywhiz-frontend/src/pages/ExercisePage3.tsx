...
const ExercisePage3 = () => {
  ...
  // Hardcoded exercise data for milestone 3
  const exerciseData: Exercise = {
    id: 3,
    title: "Python Loops Quiz - Milestone 3",
    description: "Test your understanding of Python loops. Select the best answer for each question.",
    questions: [
      {
        id: 1,
        text: "Which loop is used when you know exactly how many times you want to repeat a block of code?",
      ...
      },
      {
        ...
        options: [
          ...
          "The loop will cause a syntax error",
        ],
        correctAnswer: 2,
      },
      {
        id: 3,
        text: "Which keyword can be used to skip the current iteration of a loop and continue with the next?",
        ...
        {milestoneAchieved && (
          <div className="bg-green-50 border border-green-200 text-green-700 rounded-xl p-4 mb-8 flex items-center">
            ...
            <div>
              ...
              <p>You've completed Milestone 3! You're becoming a Python loops expert!</p>
            </div>
          </div>
        )}
