...
const CodePage8 = () => {
  ...
  const [code, setCode] = useState(`# Milestone 8: Text Adventure Game
# Build a simple text adventure game that allows the player to move between rooms
# and interact with objects

# The game should:
# 1. Have at least 3 rooms/locations
# 2. Allow the player to move between rooms using commands like "go north", "go south", etc.
# 3. Include at least 2 items the player can interact with
# 4. Include a win condition

# You can use this template to get started, or create your own structure

def display_room(current_room, rooms):
...
def main():
    ...
    rooms = {
        ...
        #     'exits': {'north': 'next_room_name', 'south': 'another_room_name'},
        #     'items': ['item1', 'item2']
        # }
    }
    
    # Set starting room and initialize player inventory
...
`)
  ...
  const lessonData = {
    title: "Milestone 8: Creating a Text Adventure Game",
    description:
      "In this final exercise, you'll apply everything you've learned to create a text adventure game. This project will combine variables, functions, conditionals, loops, lists, dictionaries, and error handling to create an interactive experience.",
  }
  ...
  const handleRunCode = async () => {
    ...
    try {
      ...
      // Check if the code is correct (contains key game elements)
      const isCorrect = 
        code.includes("rooms = {") && 
            ...
            <div className="bg-white rounded-xl p-6 shadow-md flex-grow">
              ...
              {isSuccess && (
                <div className="mb-4 p-3 bg-green-50 border border-green-200 text-green-600 rounded-lg flex items-start">
                  ...
                  <span>Amazing! You've created a working text adventure game. You're now a Python programmer!</span>
                </div>
              )}
