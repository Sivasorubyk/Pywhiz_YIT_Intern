...
const LearnPage3 = () => {
  ...
  const lessonData = {
    title: "Milestone 3: Lists and Loops",
    description:
      "Welcome to Milestone 3! In this lesson, we'll explore lists and loops in Python. Lists allow you to store multiple items in a single variable, while loops help you repeat actions efficiently. These concepts are fundamental for handling collections of data and automating repetitive tasks.",
    videoUrl: "/videos/milestone3-intro.mp4", // This should be your actual video path
  }
          ...
          <div className="bg-[#003366] rounded-xl overflow-hidden shadow-lg">
            <div className="relative aspect-w-16 aspect-h-9 bg-black">
              <video
                ...
                poster="/images/milestone3-thumbnail.jpg"
            ...
            <div className="bg-white rounded-xl p-6 shadow-md flex items-center">
              ...
              <div>
                <p className="text-gray-700">
                  After watching this video, you'll move on to the coding exercise where you'll practice working with
                  lists and loops.
                </p>
              </div>
              <button
