...
const LearnPage2 = () => {
  ...
  const lessonData = {
    title: "Milestone 2: Functions and Modules",
    description:
      "Welcome to Milestone 2! In this lesson, we'll explore functions and modules in Python. Functions allow you to organize your code into reusable blocks, making your programs more efficient and easier to understand. Modules help you organize related functions and variables, allowing you to build more complex programs.",
    videoUrl: "/videos/milestone2-intro.mp4", // This should be your actual video path
  }
          ...
          <div className="bg-[#003366] rounded-xl overflow-hidden shadow-lg">
            <div className="relative aspect-w-16 aspect-h-9 bg-black">
              <video
                ...
                poster="/images/milestone2-thumbnail.jpg"
            ...
            <div className="bg-white rounded-xl p-6 shadow-md flex items-center">
              ...
              <div>
                <p className="text-gray-700">
                  After watching this video, you'll move on to the coding exercise where you'll practice creating and
                  using functions.
                </p>
              </div>
              <button
