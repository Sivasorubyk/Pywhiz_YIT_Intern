...
const ExercisePage5 = () => {
  ...
  // Hardcoded exercise data for milestone 5
  const exerciseData: Exercise = {
    id: 5,
    title: "Python Conditionals Quiz - Milestone 5",
    description: "Test your understanding of Python conditionals and decision making. Select the best answer for each question.",
    questions: [
      {
        id: 1,
      ...
      {
        id: 2,
        text: "Which operator is used to compare if two values are equal?",
        options: ["=", "==", "===", "equals"],
        correctAnswer: 1,
      },
      {
        id: 3,
        text: "What does the following code print: if 5 > 3: print('Yes') else: print('No')",
        ...
        {milestoneAchieved && (
          <div className="bg-green-50 border border-green-200 text-green-700 rounded-xl p-4 mb-8 flex items-center">
            ...
            <div>
              ...
              <p>You've completed Milestone 5! Your decision-making skills are getting stronger!</p>
            </div>
          </div>
        )}
