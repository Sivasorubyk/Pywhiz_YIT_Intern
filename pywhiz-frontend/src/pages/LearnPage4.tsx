...
const LearnPage4 = () => {
  ...
  const lessonData = {
    title: "Milestone 4: Dictionaries and Sets",
    description:
      "Welcome to Milestone 4! In this lesson, we'll explore dictionaries and sets in Python. Dictionaries allow you to store data in key-value pairs, making it easy to look up information. Sets are collections of unique items, perfect for when you need to eliminate duplicates or check membership efficiently.",
    videoUrl: "/videos/milestone4-intro.mp4", // This should be your actual video path
  }
          ...
          <div className="bg-[#003366] rounded-xl overflow-hidden shadow-lg">
            <div className="relative aspect-w-16 aspect-h-9 bg-black">
              <video
                ...
                poster="/images/milestone4-thumbnail.jpg"
